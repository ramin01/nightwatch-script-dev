module.exports = {
    ...
    bag_shoprunner_express_btn : {
        selector : '#main > div > div > div > div.shopping-bag.container > div.shopping-bag__footer > div.shopping-bag__third-parties > div.shopping-bag__third-party-buttons > div',
    },
    shoprunner_cvv_field : {
        selector : '#sr_cvv_row > div > input[type="tel"]'
    },
    shoprunner_complete_purchase_button : {
        selector: '#pr_complete_btn'
    },
}