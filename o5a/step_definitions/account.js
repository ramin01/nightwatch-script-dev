...
var {o5aConstants : constants} = client.globals
    ...
    Then(/^I should be taken to the login page$/, () => {
        ...
        .waitForElementVisible(ref.acc_loginNewaccount_class.selector, constants.timeout_median, true)
    })
    ...
    */
    ...
    Then(/^I should be taken to the account summary page$/, () => {
        ...
        .waitForElementVisible(ref.acc_pageheader_class.selector,constants.timeout_median, true)
    })
