module.exports = {
    ...
    acc_favoritesTab_css : {
        selector : 'div > div.account__header-section > div > div > ul > li:nth-child(8) > a',
    },
    acc_favoritesPage_css : {
        selector : '#favorites-container',
    },
    /* ACCOUNT SAKSFIRST/REWARDS PAGE*/
    acc_saksfirstTab_css : {
        selector :'div > div.account__header-section > div > div > ul > li:nth-child(6) > a',
    },
    acc_saksRewards_class :{ //new user, no rewards info
        selector : '.rewards-page__tag-line',
    },
}